  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          The request could not be completed. Your data has not been changed and the operation can
          be retried.
        </p>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Incident Intelligence" },
      {
        name: "description",
        content:
          "AI-powered ServiceNow incident classification, similarity and cluster intelligence platform.",
      },
